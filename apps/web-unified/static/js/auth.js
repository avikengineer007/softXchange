...
(function (window) {
  ...
  const isRailway = typeof window !== 'undefined' && (window.location.hostname.endsWith('railway.app') || window.location.origin === RAILWAY_BACKEND);
  const origin = isRailway ? '' : (isProd ? RAILWAY_BACKEND : '');
